...
const jspmDependencies = Object.fromEntries(
    ...
    .map(jspmDepString => {
        ...
        const finalVersion = name.endsWith("es5-shim") ? `v${version}` : version;
        return [
...
console.log(`Wrote alternate package.json to jspm_workaround/${outputPath} , which surfaces the JSPM dependencies`)
