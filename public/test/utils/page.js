...
import defaultPackages from 'test/fixtures/story-packages';
...
export default class Page {
    constructor(url, {
        ...
        fixPackages = defaultPackages
    } = {}, done) {
        this.testConfig = testConfig;
        this.routerParams = extractRouterParamsFromUrl(url);

        this.mocks = installMocks({
            fixCollections,
            fixArticles,
            latestPackages: fixPackages.latest,
            storyPackages: fixPackages.all
        });
